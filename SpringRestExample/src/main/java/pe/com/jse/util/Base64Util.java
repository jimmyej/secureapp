...
/**
 * <p>
 * Encodes and decodes to and from Base64Util notation.
 * </p>
 * <p>
 ...
 * </p>
 * 
 * <code>String encoded = Base64Util.encode( myByteArray );</code> <br />
 ...
 * I've got Base64Util set to this behavior now, although earlier versions broke
 * lines by default.
 * </p>
 * 
 * <p>
 * The constants defined in Base64Util can be OR-ed together to combine options, so
 ...
 * Base64Util.OutputStream closed the Base64Util encoding (by padding with equals signs)
 ...
 * encoding/decoding from one file to the next. Also added these Base64Util
 * dialects:
 * <ol>
 ...
 * the new Base64Util dialects.</li>
 * 
...
public class Base64Util {
	...
	/**
	 * Encode using Base64Util-like encoding that is URL- and Filename-safe as
	 ...
	 * data encoded this way is <em>not</em> officially valid Base64Util, or at the
	 * very least should not be called Base64Util without also specifying that is
	 * was encoded using the URL- and Filename-safe dialect.
	 */
	public final static int URL_SAFE = 16;

	/**
	 * Encode using the special "ordered" dialect of Base64Util described here: <a
	...
	/**
	 * Translates a Base64Util value to either its 6-bit reconstruction value or a
	 ...
	 * returns a four-byte array in Base64Util notation. The actual number of
	 ...
	 * resulting four Base64Util bytes to <var>destination</var>. The source and
	...
	/**
	 * Performs Base64Util encoding on the <code>raw</code> ByteBuffer, writing it
	...
	/**
	 * Serializes an object and returns the Base64Util-encoded version of that
	 * serialized object.
	 * 
	 * <p>
	 ...
	 * <p>
	 * Example:
	 * <code>encodeObject( myObj, Base64Util.GZIP | Base64Util.DO_BREAK_LINES )</code>
	 * 
	 * @param serializableObject
	 *            The object to encode
	 * @param options
	...
	/**
	 * Encodes a byte array into Base64Util notation. Does not GZip-compress data.
	 * 
	 * @param source
	 *            The data to convert
	 ...
	 * <p>
	 * Example:
	 * <code>encodeBytes( myData, Base64Util.GZIP | Base64Util.DO_BREAK_LINES )</code>
	 * 
	 * 
	 * <p>
	...
	public static byte[] decode(byte[] source, int off, int len, int options)
		...
		if (len == 0) {
			...
			throw new IllegalArgumentException(
					"Base64Util-encoded string must have at least four characters, but length specified was "
							+ len);
		} // end if
		...
		for (i = off; i < off + len; i++) { // Loop through source
			...
			if (sbiDecode >= WHITE_SPACE_ENC) {
				...
				throw new java.io.IOException(String.format(
						"Bad Base64Util input character '%c' in array position %d",
						source[i], i));
			} // end else:
	...
	/**
	 * Decodes data from Base64Util notation, automatically detecting
	...
	/**
	 * Attempts to decode Base64Util data and deserialize a Java Object within.
	 * Returns <tt>null</tt> if there was an error.
	 * 
	 * @param encodedObject
	 *            The Base64Util data to decode
	 ...
	 * 
	 * @param dataToDecode
	 *            Base64Util-encoded data as a string
	 * @param filename
	 ...
	 * to/from Base64Util notation on the fly.
	 * 
	 * @see Base64Util
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Util.InputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		...
		/**
		 * Reads enough of the input stream to convert to/from Base64Util and
		...
		public int read() throws java.io.IOException {
			...
			if (position < 0) {
				...
				// Else decoding
					...
					if (i == 4) {
						...
						throw new java.io.IOException(
								"Improperly padded Base64Util input.");
					} // end
			...
			// Else error
				...
				throw new java.io.IOException(
						"Error in Base64Util code reading stream.");
			} // end else
		} // end read
	 ...
	 * encode/decode to/from Base64Util notation on the fly.
	 * 
	 * @see Base64Util
	 * @since 1.3
	 */
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Writes the byte to the output stream after converting to/from Base64Util
